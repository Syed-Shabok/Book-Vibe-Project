...
const ListedReadBooks = ({ sortType }) => {
  const { readList } = useContext(BookContext);

  let renderList = readList;
  if (sortType === "Rating") {
    renderList = [...readList].sort((a, b) => a.rating - b.rating);
  } else if (sortType === "Year Published") {
    renderList = [...readList].sort(
      (a, b) => a.yearOfPublishing - b.yearOfPublishing,
    );
  } else if (sortType === "Number of Pages") {
    renderList = [...readList].sort((a, b) => a.totalPages - b.totalPages);
  }
